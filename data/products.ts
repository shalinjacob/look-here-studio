...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "A single sheet of steel cut into a cat mid-stretch, tail up, with a heart lifted straight out of its middle — so the wall behind becomes the heart. In a glossy cherry red that reads from across the room. Sentimental, but it refuses to be soppy about it.",
    material: "Laser-cut steel",
    finish: "Cherry red powder-coat",
    colour: "Cherry red",
    ...
    lifestyleImages: ["/lifestyle/cat-heart-1.jpg"],
    imageFit: "cover",
    leadTime: "Made to order · 2 weeks",
    ...
    featured: false,
    process: STD_PROCESS,
    seoTitle: "Cat Got Your Heart — a cherry-red steel cat wall object",
    seoDescription: "A laser-cut steel cat with a heart cut out of its middle, in cherry red.",
  },
  {
    id: "p026",
    objectNumber: "026",
